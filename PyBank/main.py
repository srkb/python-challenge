...
pybank_budget_data=os.path.join("/Users/3544000/workspace2/dataAnalytics/python-challenge/PyBank/Resources/budget_data.csv")
...
# Export to file
output_file = os.path.join('/Users/3544000/workspace2/dataAnalytics/python-challenge/PyBank/analysis', 'pyBank_output.txt')
